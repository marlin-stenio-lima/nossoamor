        ...
        <div className="p-4 lg:p-8 max-w-5xl mx-auto font-sans">
            ...
            <div className="mt-12 p-6 bg-rose-50 rounded-xl border border-rose-100 text-center text-sm">
                ...
                <p className="text-rose-700">
                    ...
                    <span className="font-mono bg-white px-1 rounded mt-2 inline-block border border-rose-200">ansiedade.pdf</span>, <span className="font-mono bg-white px-1 rounded mt-2 inline-block border border-rose-200">controle.pdf</span>, <span className="font-mono bg-white px-1 rounded mt-2 inline-block border border-rose-200">desafio24.pdf</span>
                </p>
            </div>
        </div>
    );
